...
def classify(X_train, y_train, X_valid, y_valid, AuX_train, Auy_train, aux, auy):
    ...
    Vanilla_Classifier(X_train, y_train, X_valid, y_valid, restore = 0)    
    
    print '\n===== Training with augmentation data =====\n'
    Vanilla_Classifier(aux, auy, X_valid, y_valid, restore = 0)
    
    print '\n===== Training with data augmentation =====\n'
    Vanilla_Classifier(X_train, y_train, X_valid, y_valid, restore = 1) 
    
    print '\n===== Training with all the data =====\n'
    Vanilla_Classifier(AuX_train, Auy_train, X_valid, y_valid, restore = 0)
