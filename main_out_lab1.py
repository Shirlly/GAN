# -*- coding: utf-8 -*-
"""
Created on Wed Jun 21 15:12:24 2017
...
def train(modelclass, dt=None):
    ...
    return save_path, X_train, y_train, X_valid, y_valid, AuX_train, Auy_train
...
if __name__ == '__main__':
    ...
    if args.train:
        if args.dt:
            ...
            modelpath, X_train, y_train, X_valid, y_valid, AuX_train, Auy_train = train(args.modelclass, dt)
            classify(X_train, y_train, X_valid, y_valid, AuX_train, Auy_train)
